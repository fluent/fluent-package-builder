...
* aws-partitions v1.1287.0 (update)
* aws-sdk-core v3.257.0 (update)
* aws-sdk-kms v1.132.0 (update)
* aws-sdk-s3 v1.232.0 (update)
* aws-sdk-sqs v1.119.0 (update)
* aws-sigv4 v1.12.1
...
* prometheus-client v5.0.0 (update)
* rdkafka v0.21.0
* ruby-kafka v1.5.0
...
* fluent-plugin-windows-eventlog v0.9.3 (update)
