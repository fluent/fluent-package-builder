...
## Release v6.0.5 - 2026/09/29

### News

* Update bundled Fluentd to v1.19.4
* Update bundled gems
  * oj: fixed multiple SEGV and leaks.
  * json: fixed CVE-2026-54696
* msi: fixed a broken link to enterprise services on popup window. (#1079)
* rpm: keep compatibility with older RHEL 9.x and 10.x (#1089, #1090)
* rpm deb: disable LTO for RHEL10 and Ubuntu (#1102)
...
* OpenSSL 3.0.8 macOS
* gems
  * fluentd v1.19.4 (update)
  * msgpack 1.8.5 (update)
  * oj 3.17.6 (update)
  * webrick 1.9.2
  * openssl 3.3.0
...
* fluent-plugin-kafka v0.19.8 (update)
...
* fluent-plugin-opensearch v1.1.7 (update)
* fluent-plugin-opentelemetry 0.5.4 (update)
...
* msi: fixed installation rollback issue when executing maintenance script (#982)
